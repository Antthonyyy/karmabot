...
console.log('🚀 Starting Karma Tracker application...');
console.log('📋 Environment check:');

if (!checkEnvVariables()) {
  console.log('⚠️  Некоторые обязательные переменные окружения отсутствуют');
  console.log('📝 Приложение может работать с ограниченной функциональностью');
} else {
